...
pw-link cube-hmd:netump_out  "Midi-Bridge:Sushilisten:in (playback)"
pw-link cube-keyboard:netump_out cube-hmd:netump_in 
pw-link cube-hmd:netump_out cube-keyboard:netump_in
