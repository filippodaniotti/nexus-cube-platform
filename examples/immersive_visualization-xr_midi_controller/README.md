...
systemctl --user enable jacknetumpd-hmd.service
systemctl --user enable jacknetumpd-keyboard-mdns.service
systemctl --user enable jacknetumpd-hmd-mdns.service
...
systemctl --user start jacknetumpd-hmd.service
systemctl --user start jacknetumpd-keyboard-mdns.service
systemctl --user start jacknetumpd-hmd-mdns.service
